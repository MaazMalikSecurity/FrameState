      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center">
            <span className="text-2xl font-bold text-primary">FrameState</span>
          </Link>
          ...
          <ul className="hidden md:flex items-center gap-8">
            ...
            <li className="dropdown relative">
              ...
              {/* Dropdown Menu with slower fade */}
              <ul className="dropdown-menu absolute top-full left-0 mt-2 w-64 bg-background border border-border rounded-lg shadow-xl py-2 z-50">
            ...
            <li>
              <Link 
                to="/free-trial" 
                className={`font-medium transition-colors hover:text-primary ${
                  location.pathname === "/free-trial" ? "text-primary" : "text-foreground"
                }`}
              >
                Free Trial
              </Link>
